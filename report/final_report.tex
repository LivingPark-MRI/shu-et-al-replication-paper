...
\begin{itemize}
\item Why predicting PD progression is useful 
\item The potential of MRI features. Explain the need to assess them comparatively to demographics/clinical models.
\item Shu et al and Arafe et al
\item Axes of variability: medication status (on vs off), feature extraction, cross-validation scheme
\item This study: build on Arafe et al, abstracting methods from Shu et al. Additional cohort definitions. Feature extraction (angled).
\end{itemize}
